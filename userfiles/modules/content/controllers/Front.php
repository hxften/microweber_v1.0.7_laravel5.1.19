...
class Front
{
    ...
    function index($params, $config)
    {
        //$params 等于1时
        /*array(15) {["data-class"]=>
              string(27) "module  module module-posts"
              ["class"]=>
              string(27) "module  module module-posts"
              ["mw-title"]=>
              string(10) "Posts List"
              ["data-mw-title"]=>
              string(10) "Posts List"
              ["data-id"]=>
              string(44) "module-posts5a429b670652d52464f6d3010c8732d8"
              ["id"]=>
              string(44) "module-posts5a429b670652d52464f6d3010c8732d8"
              ["data-content-id"]=>
              string(1) "4"
        ...
        /*$config =  array(15) { 
            ["path"]=> string(51) "D:\xampp\htdocs\microweber\userfiles\modules\posts\" 
            ["mp"]=> string(51) "D:\xampp\htdocs\microweber\userfiles\modules\posts\" ["path_to_module"]=> string(51)"D:\xampp\htdocs\microweber\userfiles\modules\posts\" ["the_module"]=> string(5) "posts" 
            ["module"]=> string(5) "posts" 
            ["module_name"]=> string(1) "." 
            ["module_name_url_safe"]=> string(5) "posts" 
            ["url"]=> string(51) "http://microweber.app/blog/current_page1993782929:2" 
            ["url_base"]=> string(51) "http://microweber.app/blog/current_page1993782929:2" 
            ["url_main"]=> string(51) "http://microweber.app/blog/current_page1993782929:2" 
            ["module_api"]=> string(31) "http://microweber.app/api/posts" ["module_view"]=> string(34) "http://microweber.app/module/posts" ["ns"]=> string(5) "posts" 
            ["module_class"]=> string(12) "module-posts" 
            ["url_to_module"]=> string(46) "http://microweber.app/userfiles/modules/posts/" } */

        $current_page = $current_page = 1;
        $post_params = $params;
        if (isset($post_params['id'])) {
            //string(22) "current_page1993782929"
 ...
 if($is_search){
  //dd(DB::getQueryLog(), $content);
        ...
        if ($cfg_data_hide_paging != 'y') {
            /*$post_params_paging = array(16) { ["data-content-id"]=> string(1) "4" ["content-id"]=> string(1) "4" ["type"]=> string(5) "posts" ["data-type"]=> string(5) "posts" ["module"]=> string(5) "posts" ["parent-module"]=> string(5) "posts" ["parent-module-id"]=> string(44) "module-posts5a429b670652d52464f6d3010c8732d8" ["limit"]=> string(1) "5" ["data-limit"]=> string(1) "5" ["parent"]=> int(4) ["current_page"]=> int(1) ["content_type"]=> string(4) "post" ["is_active"]=> int(1) ["is_deleted"]=> int(0) ["order_by"]=> string(13) "position desc" ["page_count"]=> bool(true) } */
