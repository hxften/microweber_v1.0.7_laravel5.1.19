...
//var_dump(mw()->user_manager->session_all());
//$for = 'modules'
/*$params = array (size=13)
  'data-for' => string 'modules' (length=7)
  'for' => string 'modules' (length=7)
  'data-for-id' => string 'pictures-20170904155656' (length=23)
  'for-id' => string 'pictures-20170904155656' (length=23)
  'data-id' => string 'mw-pics-list-live-ed' (length=20)
  'id' => string 'mw-pics-list-live-ed' (length=20)
  'parent-module' => string 'pictures/admin' (length=14)
  'data-parent-module' => string 'pictures/admin' (length=14)
  'parent-module-id' => string 'pictures-20170904155656' (length=23)
  'data-parent-module-id' => string 'pictures-20170904155656' (length=23)
  'type' => string 'pictures/admin_backend' (length=22)
  'data-type' => string 'pictures/admin_backend' (length=22)
  'module' => string 'pictures/admin_backend' (length=22)*/
$for =  mw()->database_manager->assoc_table_name($for);  //modules
