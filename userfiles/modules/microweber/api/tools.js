...
mw.tools = {
    ...
    tree: {
        ...
        del: function (id) {
            mw.tools.confirm(mw.msg.del, function () {
                ...
                //alert(mw.settings.site_url + "api/content/delete");
                // http://microweber.app/api/content/delete  
                // src/Microweber/Providers/Content/ContentManagerHelpers.php/delete
    ...
    template_settings: function (justInit) {
        ...
        if (mw.$('.mw-template-settings').length === 0) {
            //http://microweber.app/api/module?id=settings/template&live_edit=true&module_settings=true&type=settings/template&autosize=false
