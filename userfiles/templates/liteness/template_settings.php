<div id="settings-holder">
  ...
  <script>
      ...
      setScheme = function(scheme){
        ...
        //http://microweber.app/userfiles/templates/liteness/css/colors/default.css?v=1487945240382
      ...
      $(document).ready(function(){
          ...
          mw.$(".pick-scheme").click(function(){
            if(!$(this).hasClass('active')){
                ...
                var val = $(this).dataset('value');
                //  选择配色方案 blue kuler orange pink purple
                setScheme(val);
          ...
          mw.$("#font_family").bind("change", function(){
            ...
            _body.className+=' '+val;
            //bgimage1 mw-live-edit loaded bup notranslate font-verdana
            //console.log(_body.className);
