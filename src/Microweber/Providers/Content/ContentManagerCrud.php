...
class ContentManagerCrud extends Crud
{
    ...
    public function get($params = false)
    {
        ...
        //echo '<pre>';echo 'q';
        //var_Dump($params);
        //var_Dump($params);//array(2) { ["url"]=> string(29) "blog/current_page1993782929:1" ["single"]=> bool(true) }
        ...
        /*$params = array(5) {
          ["url"]=>
          string(29) "blog/current_page1993782929:1"
          ["single"]=>
          bool(true)
          ["is_deleted"]=>
          int(0)
        ...
        if (isset($params['count']) or isset($params['single']) or isset($params['one']) or isset($params['data-count']) or isset($params['page_count']) or isset($params['data-page-count'])) {
            ...
            if (isset($get['url'])) {
               ...
               /*array(38) {
                  ...
                  string(7) "default"
                  ["layout_file"]=>
                  string(17) "layouts__blog.php"
                  ["posted_at"]=>
                  string(19) "2017-08-11 20:43:42"
                  ["full_url"]=>
                  string(26) "http://microweber.app/blog"
                }*/
            }
