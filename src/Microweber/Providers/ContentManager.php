...
class ContentManager
{
    ...
    {
    //$params = string(56) "num=1&paging_param=current_page1993782929&current_page=2"
        $params = parse_params($params);
        /*array(3) { ["num"]=> string(1) "1" ["paging_param"]=> string(22) "current_page1993782929" ["current_page"]=> string(1) "2" }*/
        $pages_count = 1;
        $base_url = false;
...
//                    print_r($e->getTraceAsString());
        ...
        // ten 测试官方网站域名常量定义20170804
        $SITENAME = $_SERVER["SERVER_NAME"];
        if (defined('SITE_SERVER_NAME') == false) {
            define('SITE_SERVER_NAME', $SITENAME, TRUE);
        }
